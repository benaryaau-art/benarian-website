...
function initialiseBenarianRuntime() {
  ...
  loadScriptOnce('assets/live-concierge.js?v=20260723b', 'data-benarian-live-concierge');
  loadScriptOnce('assets/install-app-prompt.js?v=20260723', 'data-benarian-install-prompt');
}
