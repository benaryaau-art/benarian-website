(() => {
  ...
  style.textContent = `
    ...
    .hotels-best-price{margin-top:26px;max-width:620px;padding:18px 20px;border:1px solid rgba(230,181,84,.82);border-radius:14px;background:rgba(15,12,8,.78);backdrop-filter:blur(8px);box-shadow:0 14px 40px rgba(0,0,0,.24);box-sizing:border-box}
    ...
    #benarian-hotels-reservation{position:relative;padding:54px 6% 64px;background:radial-gradient(circle at top,#2a2118 0,#17130e 55%,#0e0b08 100%);border-top:1px solid #c8953d;border-bottom:1px solid #c8953d;color:#fff;scroll-margin-top:90px;overflow:hidden}
    .hotels-reservation-inner{max-width:1080px;width:100%;margin:auto;text-align:center;box-sizing:border-box}
    ...
    .hotels-booking-form{display:grid;grid-template-columns:2fr 1fr 1fr auto;gap:12px;align-items:end;width:100%;max-width:100%;box-sizing:border-box;background:#fff;border:1px solid #c9953f;border-radius:18px;padding:20px;box-shadow:0 22px 60px rgba(0,0,0,.4);text-align:left;overflow:hidden}
    .hotels-booking-form>*{min-width:0;max-width:100%;box-sizing:border-box}
    .hotels-booking-form label{display:block;min-width:0;color:#8d6424;font:800 9px/1 Inter,Arial,sans-serif;letter-spacing:1.2px}
    .hotels-booking-form input{display:block;width:100%;min-width:0;max-width:100%;box-sizing:border-box;margin-top:8px;padding:14px 12px;border:1px solid #cfc7bb;border-radius:8px;background:#fff;color:#17130e;font:500 14px Inter,Arial,sans-serif}
    .hotels-booking-form button{min-width:0;min-height:48px;padding:13px 22px;border:0;border-radius:8px;background:#c58c28;color:#fff;font:800 11px Inter,Arial,sans-serif;letter-spacing:.8px;cursor:pointer;white-space:nowrap}
    ...
    @media(max-width:760px){
      .hotels-best-price{width:100%;max-width:100%;padding:16px;margin-top:22px}.hotels-best-price strong{font-size:20px}.hotels-best-price span{font-size:12px}
      #benarian-hotels-reservation{padding:40px 12px 56px}.hotels-reservation-inner{width:100%;max-width:100%}.hotels-reservation-inner h2{font-size:34px}
      .hotels-booking-form{display:block;width:100%;max-width:100%;padding:14px;border-radius:14px;overflow:hidden}
      .hotels-booking-form label{display:block;width:100%;max-width:100%;margin:0 0 16px;overflow:hidden}
      .hotels-booking-form input,.hotels-booking-form input[type="date"],.hotels-booking-form input[type="text"]{display:block!important;width:100%!important;min-width:0!important;max-width:100%!important;height:52px!important;box-sizing:border-box!important;margin:8px 0 0!important;padding:12px 14px!important;font-size:16px!important;-webkit-appearance:none;appearance:none}
      .hotels-booking-form button{display:block;width:100%;max-width:100%;white-space:normal}
      .hotels-widget-shell{max-height:420px}.hotels-widget-shell iframe{max-height:400px!important}
