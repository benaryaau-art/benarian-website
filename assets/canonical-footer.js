(() => {
  const FOOTER_HTML = `
    <footer class="footer lux-footer benarian-canonical-footer">
      ...
      <div class="benarian-footer-group"><strong>Follow Us</strong><p class="benarian-socials"><a href="https://www.instagram.com/benarianhotels" target="_blank" rel="noopener" aria-label="Instagram">◎</a><span>f</span><a href="contact.html" aria-label="Email">✉</a></p></div>
  ...
  style.textContent = `
    ...
    .benarian-footer-brand{display:flex!important;align-items:center!important;text-decoration:none!important;min-width:0!important;grid-column:1!important}
    .benarian-footer-mark{font:600 52px/.75 'Cormorant Garamond',Georgia,serif!important;color:#b9872c!important;letter-spacing:-8px!important;margin-right:20px!important;transform:scaleX(.84)!important}
    .benarian-footer-copy{display:flex!important;flex-direction:column!important}.benarian-footer-copy strong{font:600 31px/.9 'Cormorant Garamond',Georgia,serif!important;letter-spacing:5px!important;color:#151310!important;white-space:nowrap!important}.benarian-footer-copy small{margin-top:8px!important;font:700 8px/1.2 Inter,Arial,sans-serif!important;letter-spacing:1.45px!important;color:#b9872c!important;white-space:nowrap!important}
    .benarian-footer-concierge{grid-column:1!important;display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:8px!important;margin-top:-12px!important}.benarian-footer-live{display:inline-flex!important;align-items:center!important;gap:9px!important;padding:11px 15px!important;border:1px solid #c8953d!important;border-radius:999px!important;color:#755f45!important;text-decoration:none!important;font:700 10px Inter,Arial,sans-serif!important;letter-spacing:.9px!important}.live-dot{width:9px!important;height:9px!important;border-radius:50%!important;background:#25d366!important;box-shadow:0 0 0 5px rgba(37,211,102,.14)!important}.benarian-footer-concierge p{margin:0!important;font:500 12px/1.5 Inter,Arial,sans-serif!important;color:#746a5d!important}
    .benarian-footer-group{display:flex!important;flex-direction:column!important;gap:10px!important}.benarian-footer-group strong{font:700 14px Inter,Arial,sans-serif!important;color:#211d18!important}.benarian-footer-group a,.benarian-footer-group p{margin:0!important;color:#766d61!important;text-decoration:none!important;font:400 12px/1.5 Inter,Arial,sans-serif!important}.benarian-footer-group a:hover{color:#9b681a!important}.benarian-socials{display:flex!important;gap:14px!important;align-items:center!important}.copyright{grid-column:1/-1!important;margin:12px 0 0!important;padding-top:22px!important;border-top:1px solid #e8dcc7!important;color:#91877a!important;font:400 11px Inter,Arial,sans-serif!important}
    @media(max-width:850px){.benarian-canonical-footer{grid-template-columns:1fr 1fr!important;padding:42px 22px 190px!important;gap:28px 24px!important}.benarian-footer-brand,.benarian-footer-concierge{grid-column:1/-1!important}.benarian-footer-group:nth-of-type(3){grid-column:1/-1!important}.benarian-footer-mark{font-size:47px!important}.benarian-footer-copy strong{font-size:28px!important;letter-spacing:4px!important}.copyright{grid-column:1/-1!important}}
    @media(max-width:420px){.benarian-canonical-footer{padding-left:20px!important;padding-right:20px!important}.benarian-footer-copy strong{font-size:25px!important;letter-spacing:3.3px!important}.benarian-footer-copy small{font-size:7px!important;letter-spacing:1.1px!important}.benarian-footer-live{font-size:9px!important;max-width:100%!important}.benarian-footer-group{min-width:0!important}}
  `;
  if (!document.getElementById(style.id)) document.head.appendChild(style);
  applyCanonicalFooter();
  new MutationObserver(applyCanonicalFooter).observe(document.documentElement,{childList:true,subtree:true});
})();